            ...
            <div class="md:max-w-screen-sm lg:max-w-[992px] px-4 sm:px-6 lg:px-8 pb-12 md:pt-6 sm:pb-20 mx-auto">
                <div class="grid gap-4 md:gap-8">
                    ...
                    <div>
                        ...
                        <p class="dark:text-gray-400">
                            A percentage of 5-10% is deducted from the room reservation price, where the customer pays the full amount to our platform, and we transfer the hotel percentage upon completion of the reservation and payment
                        </p>
                    </div>
                </div>
            </div>
